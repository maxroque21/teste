function scratchCard(imgPrinc, imgScrateched, imgWidth, imgHeight) {
    ...
    if (imgPrinc && imgScrateched) {
        ...
        var container = document.getElementById('js-container'), setImgWidth = imgWidth ? imgWidth : container.clientWidth, setImgHeight = imgHeight ? imgHeight : container.clientWidth, discountIMG = document.getElementById("discountIMG"), canvas = document.getElementById('js-canvas'), canvasWidth = canvas.width, canvasHeight = canvas.height, ctx = canvas.getContext('2d'), image = new Image(), brush = new Image();
        image.src = imgPrinc;
        ...
        if (imgWidth)
            container.setAttribute("style", "max-width:" + setImgWidth + "px !important;");
        ...
        function getFilledInPixels(stride) {
            ...
            var pixels = ctx.getImageData(0, 0, canvasWidth, canvasHeight), pdata = pixels.data, l = pdata.length, total = (l / stride), count = 0;
        ...
        if (!imgPrinc) {
            console.log("imgPrinc is missing");
        }
        ;
        if (!imgScrateched) {
            console.log("imgScrateched is missing");
        }
        ;
    }
}
